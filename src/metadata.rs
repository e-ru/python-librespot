...
fn get<T, F, O>(py: Python,
                ...
                handle : Remote,
                id: librespot::core::spotify_id::SpotifyId,
...
fn get_all<T, F, O, I>(py: Python,
    ...
    where
        ...
        O: PythonObject,
        I: IntoIterator<Item = librespot::core::spotify_id::SpotifyId>,
        I::IntoIter: 'static
{
...
impl Track {
    pub fn get(py: Python,
               session: librespot::core::session::Session,
               handle : Remote,
               id: librespot::core::spotify_id::SpotifyId) -> PyResult<PyObject>
    {
    ...
    pub fn get_all<I>(py: Python,
        ...
        where I: IntoIterator<Item = librespot::core::spotify_id::SpotifyId>,
              I::IntoIter: 'static
    {
